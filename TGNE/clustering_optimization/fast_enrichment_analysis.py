...
term_columns=['COG_category', 'GOs', 'KEGG_ko', 'EC']
...
if __name__ == '__main__':
    ...
    with Pool() as pool:
        module_dfs = list(tqdm.tqdm(pool.imap(process_module, sorted(lldf[f'leiden_label_{phases}'].unique())), total=len(lldf[f'leiden_label_{phases}'].unique())))
