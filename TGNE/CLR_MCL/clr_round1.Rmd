...
```{r}
full.mut.info.mat <- knnmi.all(full, k=3)
full.clr.mat <- clr(full.mut.info.mat)

save(full.clr.mat, file='./full_filt_norm_CLR_nn3.RData')
...
write.graph(full.graph, './full_clr_nn3_graph_round_1.ncol', format='ncol')


veg.mut.info.mat <- knnmi.all(veg, k=3)
veg.clr.mat <- clr(veg.mut.info.mat)

save(veg.clr.mat, file='./veg_filt_norm_CLR_nn3.RData')
...
write.graph(veg.graph, './veg_clr_nn3_graph_round_1.ncol', format='ncol')

sex.mut.info.mat <- knnmi.all(sex, k=3)
sex.clr.mat <- clr(sex.mut.info.mat)

save(sex.clr.mat, file='./sex_filt_norm_CLR_nn3.RData')
...
write.graph(sex.graph, './sex_clr_nn3_graph_round_1.ncol', format='ncol')
